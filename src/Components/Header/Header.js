    ...
    <header className="hero-header" id="home">
      ...
      <nav className="main-nav glass-panel">
        <ul className="nav-links">
          ...
          <li>
            <a href="#resume">Architecture & Impact</a>
          </li>
          <li>
      ...
      <div className="hero-content">
        ...
        <p className="hero-subtitle">
          I'm a <strong>{city}</strong> based software architect designing
          scalable systems, resilient cloud infrastructure, and modern data
